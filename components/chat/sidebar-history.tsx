      ...
      <SidebarGroup className="group-data-[collapsible=icon]:hidden">
        <SidebarGroupContent>
          <div className="flex w-full flex-row items-center justify-center gap-2 px-2 text-[13px] text-sidebar-foreground/60">
            Өмнөх чатуудаа хадгалахын тулд нэвтэрнэ үү!
          </div>
        </SidebarGroupContent>
      </SidebarGroup>
    );
  ...
  if (hasEmptyChatHistory) {
    return (
      <SidebarGroup className="group-data-[collapsible=icon]:hidden">
        ...
        <SidebarGroupContent>
          <div className="flex w-full flex-row items-center justify-center gap-2 px-2 text-[13px] text-sidebar-foreground/60">
            Чат эхлүүлсний дараа энд харагдана!
          </div>
        </SidebarGroupContent>
      </SidebarGroup>
    );
  ...
  return (
    <>
        ...
        <SidebarGroupContent>
          ...
          {hasReachedEnd ? null : (
            <div className="mt-1 flex flex-row items-center gap-2 px-4 py-2 text-sidebar-foreground/50">
              ...
              <div className="text-[11px]">Ачааллаж байна...</div>
            </div>
          )}
        </SidebarGroupContent>
      </SidebarGroup>
      ...
      <AlertDialog onOpenChange={setShowDeleteDialog} open={showDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Энэ чатыг устгах уу?</AlertDialogTitle>
            <AlertDialogDescription>
              Энэ үйлдлийг буцаах боломжгүй. Таны чат бичлэг бүрмөсөн устгагдана.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
